...
int main()
{
    ...
    FILE* helloClientFile = fopen("D:\Coding\LapTrinhMang-25.04.2022\LapTrinhMang-25.04.2022\\hello_client.txt", "r");

    FILE* clientMessage = fopen("D:\Coding\LapTrinhMang-25.04.2022\LapTrinhMang-25.04.2022\\client_message.txt", "a");
